package br.com.matheus.calculadora.controller;

import br.com.matheus.calculadora.exceptions.InvalidNumberOperationException;
import br.com.matheus.calculadora.exceptions.isNullOperationException;
import br.com.matheus.calculadora.model.Calculadora;
...
public class CalculadoraController {
    ...
    public float sum(@RequestParam("n1") String n1, @RequestParam("n2") String n2) {
        if(isNull(n1) || isNull(n2)){
            throw new isNullOperationException("Please, kys");
        }
